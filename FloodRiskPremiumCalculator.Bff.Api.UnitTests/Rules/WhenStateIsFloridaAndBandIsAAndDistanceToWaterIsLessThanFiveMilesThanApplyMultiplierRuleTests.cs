...
{
    public class WhenStateIsFloridaAndBandIsAAndDistanceToWaterIsLessThanFiveMilesThanApplyMultiplierRuleTests : TestBase
    {
        private readonly WhenStateIsFloridaAndBandIsAAndDistanceToWaterIsLessThanFiveMilesThanApplyMultiplierRule _rule = new();
        ...
        public async Task WhenOnApplyRuleThenBaseRateForStateAndBandShouldApplyCorrectly()
        {
            ...
            var expectedStatePremiumCalculation = new StateRateDto
            {
                ...
                {
                    new() { Band = BandA, Premium = 12000.0M },
